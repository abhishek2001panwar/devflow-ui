...
declare const Card: ({ companyName, companyLogo, postedTime, jobTitle, jobTags, salary, location, primaryActionLabel, primaryActionHref, isSaved, className, tagClassName, titleClassName, }: CardProps) => React.JSX.Element;
